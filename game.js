...
function preloadAssets() {
    ...
    const imagesToLoad = [
        { img: bonkmanImg, src: 'assets/bonkman.png' },
        { img: malletRedImg, src: 'assets/mallet_red.png' },
        { img: malletBlueImg, src: 'assets/mallet_blue.png' },
        { img: malletGreenImg, src: 'assets/mallet_green.png' },
        { img: coinImg, src: 'assets/coin.png' },
        { img: powerUpImg, src: 'assets/powerup.png' }
    ];
    ...
    // We can also add promises for audio if needed, but 'canplaythrough' is less reliable.
    // HTML audio elements are generally better at handling this.
...
preloadAssets()
    .then(() => {
        // All assets are loaded, now start the game.
        showLevelPopup(currentLevel);
